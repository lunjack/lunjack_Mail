...
class SmtpConnection extends EventEmitter {
    constructor(options = {}) {
        ...
        this.port = Number(port) || (this.secureConnection ? 465 : 587);
        this.host = host;
        ...
        // 设置日志记录器
        this.logger = getLogger(this.options, { component, sid: this.id });
    ...
    */
    ...
    _onData(chunk) {
        ...
        // 拼接剩余数据并分割行
        const lines = (this._remainder + data).split(regexs.LINE_SEPARATOR);
    ...
    _actionEHLO(str) {
        ...
        this._ehloLines = str.split(regexs.LINE_SEPARATOR)
