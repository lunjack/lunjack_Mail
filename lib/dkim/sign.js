...
// 引入必要的模块
const punycode = require('../punycode'); // 用于处理Unicode域名的punycode转换
const mimeFuncs = require('../mime-funcs'); // 提供MIME相关工具函数
...
// 将relaxedHeaders函数挂载到导出对象上，以便外部使用
...
function generateDKIMHeader(domainName, keySelector, fieldNames, hashAlgo, bodyHash) {
    ...
    let dkim = [
        ...
        'd=' + punycode.toASCII(domainName), // 域名（转换为ASCII）
        'q=dns/txt', // 查询方式
        's=' + keySelector, // 密钥选择器
        'bh=' + bodyHash, // 正文哈希
