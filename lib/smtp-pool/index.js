...
const { parseConnectionUrl, assign, getLogger, callbackPromise, createProxyConnection, initSmtpConstructor } = require('../shared');
...
class SmtpPool extends EventEmitter {
    constructor(options = {}) {
        super();
        this.name = 'SmtpPool';
        initSmtpConstructor(this, options, 'smtpPool');
    ...
    verify(callback) {
        ...
        this.getSocket(this.options, (err, socketOptions) => {
            ...
            const { options: newOptions, connection } =
                createProxyConnection(this.options, this.logger, socketOptions);
