    ...
    const socket = connect(options, () => {
        ...
        function onSocketData(chunk) {
            ...
            if (headersEndIndex !== -1) {
                ...
                const remainder = headers.substring(headersEndIndex + 4);
                const headerPart = headers.substring(0, headersEndIndex);
                ...
                socket.setTimeout(0), headerChunks = []; // 禁用超时,成功时重置 headerChunks
