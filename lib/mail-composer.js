...
class MailComposer {
    ...
    _createContentNode(parentNode, element = {}) {
        ...
        // 设置内容处置方式
        if (!regexs.TEXT_TYPE.test(contentType) || contentDisposition) node.setHeader('Content-Disposition', contentDisposition ||
            (cid && regexs.IMAGE_TYPE.test(contentType) ? 'inline' : 'attachment'));
