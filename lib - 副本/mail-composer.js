...
const { parseDataURI, regexs, resetRegex } = require('./shared');
...
class MailComposer {
    constructor(mail = {}) {
        this.mail = mail, this.message = false;
    }
    ...
    _processDataUrl(element) {
        const { path, href, contentType } = element;
        ...
        element.contentType = contentType || parsedDataUri.contentType;
